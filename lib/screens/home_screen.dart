  ...
  GetAllSchemeList() async {
    ...
    try {
      ...
      Map<String, String> headers1 = {
        ...
        'Authorization':
            'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhYWEiLCJzY29wZXMiOiJST0xFX0FETUlOIiwiaWF0IjoxNjY2MTU2MTg4LCJleHAiOjE2NjYxNzQxODh9.Ms5Wmihh2iuHHglOBmvfQx8dJahNY9uaW6IO7QPTNfo'
      };
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                                ...
                                child: Text(
                                  "Minimum Graduation Level Required : " +
                                      widget.indexOnject[index]["eligibility"]["acadDtls"][0]
                                              ["courseLevelName"]
                                          .toString(),
                                  style: TextStyle(
                                      fontSize: screenWidth * 0.033,
                            ...
                            Padding(
                                ...
                                child: Text(
                                  "Gender : " +
                                      widget.indexOnject[index]["eligibility"]["gender"],
                                  style: TextStyle(
                                      fontSize: screenWidth * 0.033,
                                      fontWeight: FontWeight.w500),
                                )),
